  ...
  const features = [
    {
      ...
      description: "Nous privilégions le bien-être des animaux et des communautés locales dans toutes nos activités",
    },
    {
      icon: Users,
      title: "Guides Locaux Experts",
      description: "Nos guides sont des habitants de Chiang Mai qui partagent leur culture et leurs connaissances",
    },
    {
      icon: Award,
      title: "Expériences Authentiques",
      description: "Découvrez la vraie Thaïlande du Nord avec des activités et des lieux hors des sentiers battus",
    },
    {
      icon: Leaf,
      title: "Respectueux de l'Environnement",
      description: "Nous nous engageons à préserver la beauté naturelle de Chiang Mai pour les générations futures",
    },
  ]
    ...
    <section id="about" className="py-20 bg-muted/50">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-4">Pourquoi Nous Choisir</h2>
        ...
        <div className="bg-background rounded-lg p-8 md:p-12">
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div>
              <h3 className="text-2xl md:text-3xl font-bold mb-4">Vos Amis Locaux à Chiang Mai</h3>
